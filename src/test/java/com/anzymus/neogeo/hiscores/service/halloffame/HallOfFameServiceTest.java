...
public class HallOfFameServiceTest {
    ...
    @Test
    public void should_get_players_order_by_rank_with_points_calculation_v2() {
        HallOfFameService hallOfFameService = new HallOfFameService();
        hallOfFameService.scoreService = scoreService;
        hallOfFameService.gameService = gameService;
        ...
        List<Player> players = hallOfFameService.getPlayersOrderByRankV2("MVS");

        assertEquals(5, players.get(0).getPoints());
        assertEquals(4, players.get(1).getPoints());
        assertEquals(4, players.get(2).getPoints());
        assertEquals(2, players.get(3).getPoints());
    }

    @Test
    public void should_get_players_order_by_rank_with_points_calculation_v2_with_more_than_10_players() {
        HallOfFameService hallOfFameService = new HallOfFameService();
        hallOfFameService.scoreService = scoreService;
        hallOfFameService.gameService = gameService;
        ...
        Scores scores = new Scores();
        scores.add(new Score("10", new Player("player1"), "MVS", fatalFury, ""));
        scores.add(new Score("9", new Player("player2"), "MVS", fatalFury, ""));
        scores.add(new Score("8", new Player("player3"), "MVS", fatalFury, ""));
        scores.add(new Score("7", new Player("player4"), "MVS", fatalFury, ""));
        scores.add(new Score("6", new Player("player5"), "MVS", fatalFury, ""));
        scores.add(new Score("5", new Player("player6"), "MVS", fatalFury, ""));
        scores.add(new Score("4", new Player("player7"), "MVS", fatalFury, ""));
        scores.add(new Score("3", new Player("player8"), "MVS", fatalFury, ""));
        scores.add(new Score("2", new Player("player9"), "MVS", fatalFury, ""));
        scores.add(new Score("1", new Player("player10"), "MVS", fatalFury, ""));
        scores.add(new Score("0", new Player("player11"), "MVS", fatalFury, ""));
        scores.add(new Score("0", new Player("player12"), "MVS", fatalFury, ""));
        scores.add(new Score("0", new Player("player13"), "MVS", fatalFury, ""));
        ...
        assertEquals(10, players.get(0).getPoints());
        assertEquals(9, players.get(1).getPoints());
        assertEquals(8, players.get(2).getPoints());
